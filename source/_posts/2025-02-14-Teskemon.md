...
<i class="icon-xcode-magic-128"></i>
...
In order to ensure consistency <i class="icon-toolbardesktopfoldericon-16"></i>and live updating across all screens all the time 
