...
Controller approach. There are three Swift packages: Model, Controller, and View. When I
make big changes, I usually post about them on Mastodon. Follow along at
...
In order to ensure consistency and live updates across all screens all the time,
...
simple and mostly consist of Tables or Forms.
